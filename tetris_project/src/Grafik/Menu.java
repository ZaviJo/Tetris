	...
	protected void paintComponent(Graphics g) {
		...
		super.paintComponent(g);
		 if(Game.zustand == Zustand.start){
			 ...
			 g.drawString("Drücke Space zum Starten", 175,Gui.hoehe_dg/2 );
			 g.setFont(Gui.schrift.deriveFont(12f));
			 ...
			 g.setFont(Gui.schrift.deriveFont(16f));
		 }else if(Game.zustand == Zustand.verloren){
			 g.setColor(new Color(153,0,0));
			 g.fillRect(0,Gui.hoehe_dg / 2 -50, Gui.breite_dg,100);
			 g.setColor(Color.BLACK);
			 g.drawString("You lost, press Space to git gud", 75,Gui.hoehe_dg/2 );
			 g.setFont(Gui.schrift.deriveFont(16f));
